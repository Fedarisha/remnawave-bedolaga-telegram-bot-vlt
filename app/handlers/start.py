...
async def _show_privacy_policy_after_rules(
    ...
    # Разбиение на страницы теперь делает edit_long_text/answer_long_text —
    # здесь остаётся только форк-заголовок поверх текста политики.
    total_pages = len(pages)
    privacy_policy_text = f'{header}\n\n{privacy_policy_text}'
