...
class NaloGoService:
    ...
    async def retry_pending_receipt(self, payment_id: str, bot: Any = None) -> str | None:
        ...
        receipt_uuid = await self.create_receipt(
            ...
            user_email=target_receipt.get('user_email') or target_receipt.get('receipt_delivery_email'),
        )
    ...
    async def create_receipt(
        ...
        Args:
            ...
            receipt_delivery_email: Email покупателя для доставки чека
            receipt_delivery_language: Язык покупателя для уведомления
