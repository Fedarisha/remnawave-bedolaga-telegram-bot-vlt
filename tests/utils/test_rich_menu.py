...
async def test_expired_subscription_renew_link_in_cabinet_mode(monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        lambda start_param: f'https://telegram.me/bot/cab?startapp={start_param}',
    )
    ...
    assert '<a href="https://telegram.me/bot/cab?startapp=renew_7">🔄 Продлить</a>' in html_out
...
async def test_trial_offer_free_deeplink(monkeypatch):
    ...
    assert '<a href="https://telegram.me/testbot?start=trial"><b>🚀 Активировать триал</b></a>' in html_out
...
async def test_trial_offer_paid_opens_miniapp(monkeypatch):
    ...
    assert 'https://telegram.me/bot/cab?startapp=trial' in html_out
